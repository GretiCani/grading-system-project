...
@OpenAPIDefinition(servers = { @Server(url = "http://localhost:8081/course-service")}, info = @Info(title = "Course Service APIs",
        description = "This lists all the Course Service API Calls. The Calls are OAuth2 secured, "
